# Operator Quickstart — Wholesale on a fee or contract basis

Shortest path from clone to a verified local dry-run for **ISIC 4610** (`cloud-itonami-isic-4610`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4610.git
cd cloud-itonami-isic-4610
```
...
- Blueprint governor key: `commission-broker-governor`
- Likely source path: `commtrade.governor.cljc`
